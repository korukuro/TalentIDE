...
import { ParkingMeter, ArrowRightIcon, ZapIcon, CheckIcon, VideoIcon, Code2Icon, UsersIcon } from 'lucide-react'
            ...
            <div className="max-w-8xl mx-auto p-4 flex items-center justify-between">
                ...
                <Link to={"/"} className='flex items-center gap-3 hover:scale-105 transition-transform duration-200'>
                    <div className='size-10 rounded-xl bg-linear-to-br from-primary via-secondary to-accent flex items-center justify-center shadow-lg'>
                        <ParkingMeter className="size-6 text-white" />
                    </div>
                    <div className='flex flex-col'>
                        <span className='font-black text-xl bg-linear-to-r from-primary via-secondary to-accent bg-clip-text text-transparent font-mono tracking-wider'>TalentIDE</span>
