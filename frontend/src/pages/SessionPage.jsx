...
//   const hasJoined = useRef(false);
  ...
  const {call,channel,chatClient, isInitializingCall, streamClient} = useStreamClient(session,sessionLoading,isHost,isParticipant)
  ...
  useEffect(() => {
    if (!session || !user || sessionLoading || !id) return;
